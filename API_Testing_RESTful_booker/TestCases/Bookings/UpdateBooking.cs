...
namespace API_Testing_RESTful_booker.TestCases
{
    ...
    public class UpdateBooking
    {
        ...
        /// and response format as JSON.It uses token for authentication.
        /// </summary>
        [TestMethod]
        [Description(@"This test updates a current booking in the API using put request in xml format" +
            "and response format as JSON. It uses token for authentication. The test steps are: " +
        ...
        public void UpdateBooking_XmlRequest_XmlResponse()
        {
            ...
            checkin = new DateTime(2016, 02, 19);
            checkout = new DateTime(2017, 02, 20);
        ...
        /// <summary>
        /// This test updates a current booking in the API using put request in UrlEncoded format 
        /// and response format as UrlEncoded
        /// </summary>
        [TestMethod]
        [Description(@"This test updates a current booking in the API using put request in Url encoded format" +
            "and response format as Url encoded. The test steps are: " +
            "\n(Step1: Make a post request to add new booking and save its bookingid" +
            "\n(Step2: Make a put request and update booking using bookingid from step1" +
            "\n(Step3: Make a get response and verify the booking has been updated")]
        ...
        /// <summary>
        /// This test updates a current booking in the API using put request in JSON format 
        /// and response format as JSON.It uses basic authentication.
        /// </summary>
        [TestMethod]
        [Description(@"This test updates a current booking in the API using put request in xml format" +
            "and response format as JSON. It uses basic authentication. The test steps are: " +
            "\n(Step1: Make a post request to add new booking and save its bookingid" +
            "\n(Step2: Make a put request and update booking using bookingid from step1" +
            "\n(Step3: Make a get response and verify the booking has been updated")]
